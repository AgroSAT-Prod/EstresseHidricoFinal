...
SAIDA = ROOT / "analiseBR16PorDia" / "dataset_gerado" / "figuras"
...
def main() -> None:
    ...
    entrada = args.entrada or (ROOT / "analiseBR16PorDia" / "dataset_gerado" / f"plsda_vip_spearman_{codigo_p}_5seeds_kfold4" / args.genotipo)
