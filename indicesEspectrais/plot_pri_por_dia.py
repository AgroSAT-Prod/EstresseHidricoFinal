...
def main() -> None:
    ...
    resumo.to_csv(ROOT / "pri_por_dia_resumo.csv", index=False, float_format="%.6f")
    ...
    fig.savefig(ROOT / "pri_por_dia_genotipos.png", dpi=300, bbox_inches="tight")
    fig.savefig(ROOT / "pri_por_dia_genotipos.pdf", bbox_inches="tight")
    print(f"Gráfico salvo em: {ROOT / 'pri_por_dia_genotipos.png'}")
