...
ENTRADA = ROOT.parent / "resultados" / "dataset_gerado" / "efeitos_simples.csv"
SAIDA = ROOT.parent / "resultados" / "dataset_gerado" / "top5_bandas_por_dia_genotipo_condicao.csv"
