...
MODULO = ROOT.parent
sys.path.insert(0, str(MODULO.parent.parent / "preprocessamento_espectral"))
sys.path.insert(0, str(MODULO.parent.parent / "testeDeNormalidade"))

from shapiro_normalidade import carregar_estagios  # noqa: E402

DADOS = MODULO.parent / "resultados" / "dataset_gerado"
SAIDA = ROOT.parent.parent / "resultados" / "curva_espectral_significancia.png"
